...
import { ArrowRight, Phone, Check, Calculator } from "lucide-react";
        ...
        <section className="py-12 md:py-16 max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-navy-600">
              Get an estimated range for your housing disrepair claim. This is an
              indicative estimate only — your solicitor will provide an accurate
              figure.
            </p>
          </div>
