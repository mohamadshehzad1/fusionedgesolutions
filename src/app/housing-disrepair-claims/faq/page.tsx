        ...
        <section className="py-12 md:py-16 max-w-3xl mx-auto">
          ...
          <div className="bg-gold-500 rounded-2xl p-8 text-center text-white">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="tel:+441618182458" className="inline-flex items-center gap-2 bg-white text-gold-700 font-bold px-8 py-3 rounded-full hover:bg-gold-50 transition-colors">
